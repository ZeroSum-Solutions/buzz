...
canonical room: `#feat-auth-fix`. The task and branch can be views of the same
channel UUID, as defined in [VISION_ROOMS.md](VISION_ROOMS.md). They work there.
...
event published. A finished branch-only room archives; a shared room stays active
