...
export function FileRow({
  ...
  return (
    ...
    // biome-ignore lint/a11y/useKeyWithClickEvents: keyboard users toggle selection via the checkbox, which owns the keydown handler
    <div
    ...
    >
      {selecting ? (
        <div className="flex shrink-0 items-center">
          {/* biome-ignore lint/a11y/useSemanticElements: custom checkbox glyph; native <input type="checkbox"> can't render the checkmark/border styling without appearance overrides, button + role="checkbox" + aria-checked gives identical AT semantics */}
          <button
